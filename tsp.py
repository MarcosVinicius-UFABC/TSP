...
Original file is located at
    https://colab.research.google.com/drive/1REkI1rm-qDi3Jn9iuIHAbj6qdzttD6m3
...
dist_mat = pd.concat(
    [dist_mat, pd.Series([(generate_dist_mat(coords))], index=[len(dist_mat)])]
)
...
def population_loop_elitism(pop_size = 50, db_num_cities = num_cities, db_dist_mat = dist_mat, epochs = 100, survival_rate = .5, mut_prob = .1, seed = 42):
  ...
  print("\nPopulação final de genótipos (elitismo)\n", pd.DataFrame(pop), "\n") # Print para verificação de convergência
